...
API_ID = int(environ.get('API_ID', '15546548'))
API_HASH = environ.get('API_HASH', 'c78ed701bbf2f5fbff175f212513a61a')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002214551592'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5079242179').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002212243453').split()]
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002241816447')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002186968765')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'killdfjj') # Support Chat Link Without https:// or @
